...
/**  ${pojo.getClassJavaDoc(pojo.getDeclarationName() + "DaoImpl generated by UDA 1.0", 0)}, ${date}.
*  @author UDA
*/
...
public class ${pojo.getDeclarationName()}DaoImpl implements ${pojo.getDeclarationName()}Dao {
    ...
    <#include "springFindAllDinamycImpl.ftl"/>
    <#foreach property in pojo.getAllPropertiesIterator()>
      <#if c2h.isManyToMany(property)>
        <#if c2h.isCollection(property)>
           <#include "springCRUDRelationImpl.ftl"/>					
        </#if>
      </#if>
    </#foreach>	
