...
<div id="mockPageContent" class="preview">
	<input type="hidden" id="mockajaxurl" style="display: none; visibility: hidden;" value="<#noparse>${param['mockUrl']}</#noparse>"/>
	<textarea id="mockusernames" style="display: none; visibility: hidden;"><#noparse>${param['userNames']}</#noparse></textarea>
