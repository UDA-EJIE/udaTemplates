...
<div id=remote style="float: left; margin-left: 4em;">
	...
	<div style="margin-left:1.5em;">
		...
		<select id="departamentoRemote" name="departamento" class="rup-combo"></select>
		
		<h3><label for="provinciaRemote">Provincia</label></h3>
		<select id="provinciaRemote" name="provincia" class="rup-combo"></select>
...
<div id=mixto style="float: left; margin-left: 4em;">
	...
	<div style="margin-left:1.5em;">
		...
		<select id="mixto_departamentoRemote" name="departamento" class="rup-combo"></select>
		
		<h3><label for="mixto_provincia">Provincia (local)</label></h3>
		<select id="mixto_provincia" name="provincia" class="rup-combo"></select>
