...
<h1><spring:message  code="maintMDPedidosTitle" /></h1>
	<div id="error" style="display:none"></div>
	<h2><spring:message  code="pedidos"/>:</h2>
...
<h2><spring:message code="lineItemsTitle" />:</h2>
<div id="EJIE_MAINT_detalle">
		<!-- Botonera de gestion de la tabla -->	
		<div id="EJIE_TOOLBAR_detalle" class="botonera"></div>
		<div id="contenido" style="margin-top:0.5em;margin-bottom:0.5em;width:600px;">
		</div>
		<div id="RUP_GRID_detalle">		
			<!-- Barra de mensajes -->
			<div id="feedbackTablaDetalle"></div>
			<!-- Tabla -->
			<table id="GRID_detalle" cellpadding="0" cellspacing="0"></table>
			<!-- Barra de paginacion -->
			<div id="pagerDetalle" style="text-align:center;"></div>
		</div>
</div>