...
<#assign tablaHija= property?substring(property?last_index_of("(")+1,property?length-1)>
	/**
	 * Adds multiple rows in ${pojo.beanCapitalize(ctrTl.findHibernateName(tablaMN?lower_case))} table.
	 * 
	...
	/**
	 * Deletes multiple rows in ${pojo.beanCapitalize(ctrTl.findHibernateName(tablaMN?lower_case))} table.
	 * 
	 * @param ${pojo.getDeclarationName()?lower_case} ${pojo.getDeclarationName()} 
	 * @return
	 */  
	...
	/**
	 * Find a single row in ${pojo.beanCapitalize(ctrTl.findHibernateName(tablaMN?lower_case))} Many To Many relationship.
	 * 
	...
	/**
	 * Counts the rows in ${pojo.beanCapitalize(ctrTl.findHibernateName(tablaMN?lower_case))} Many To Many relationship.
	 * 
	 * @param ${ctrTl.findHibernateName(ctrTl.stringDecapitalize(nombreSubclass))}
	 *            ${pojo.importType(pojo.getPackageName()+'.model.'+ pojo.beanCapitalize(nombreSubclass))}
	 * @param ${ctrTl.stringDecapitalize(pojo.getDeclarationName())}
