			...
			if (args.length > 1) {
				...
				$.each(buttons, function(index, object){
					if (object.buttons!==undefined){
						...
						$mbutton = $container.addMButton(object, {});
						$container.addButtonsToMButton(object.buttons, $mbutton, {});
						//add click
