	...
	$.widget("$.rup_language", {
		...
		_create: function () {
			...
			var self = this.element, ul = $("<ul>"), timerID,  
				liIdiomaActivo = $("<li>").attr("id", "rup_active_language").addClass("rup-language_active").text($.rup.i18n.rup_language[this.options.active]), 
				...
				divCajaIdiomas = $("<div>"), aChangeLang = $("<a>").attr("id", "rup_language_choice").addClass("rup-language_change_option").text($.rup.i18n.rup_language.changeLanguage),
				listadoIdiomas = $("<div>").addClass("rup-language_language_list"), cerrarIdioma = $("<a>").addClass("rup-language_close_languages").attr("id", "rup_language_close").attr("href", "#").attr("title", $.rup.i18n.rup_global.close), 
				span = $("<span>").addClass("rup-language_hidden").text($.rup.i18n.rup_global.close), ulPrincipal = $("<ul>");
			ul.append(liIdiomaActivo);
			
			$("<a>").attr("href", "#").text($.rup.i18n.rup_language.changeLanguage).appendTo(liEnlace);
			ul.append(liEnlace);			
			...
			$.each(this.options.languages, function (key, value) { 
				...
				var liIdioma = $("<li>").attr("id", "rup_language_lng_" + value), txt = $.rup.i18n.rup_language[value]; 
