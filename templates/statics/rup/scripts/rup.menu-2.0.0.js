				...
				if (args.length > 1) {
					...
					if(this.length > 0){
						...
						if (settings.display === "horizontal"){
							...
							$("#"+menuId+" [rupmenu_firslevel='true'] [role='menu']").css("width",settings.verticalWidth).addClass("rup_menu_vertical_horizontal");
							
						} else if (settings.display === "vertical"){
							
							//Se le especifica el tamaño del menu
							selectorSelf.css("width",settings.verticalWidth).addClass("rup_menu_vertical");
