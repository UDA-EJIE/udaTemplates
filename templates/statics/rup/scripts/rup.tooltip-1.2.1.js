...
$.widget("$.rup_tooltip", {
	...
	_init: function() {
		...
		//Se localiza el objeto mediante un atributo especifico
		this.element.attr("udaTooltipMark","true");
		
		if(this.options.applyToPortal || !$.rup_utils.aplicatioInPortal() || $(".r01gContainer [udaTooltipMark=true]").length > 0){
		...
		//Se deja el objeto como estaba
		this.element.removeAttr("udaTooltipMark"); 
	},
