	...
	$.widget("$.rup_language", {
		...
		_create: function () {
			...
			var self = this.element, ul = $("<ul>"), timerID,  
				...
				divCajaIdiomas = $("<div>"), aChangeLang = $("<a>").attr("id", "rup_language_choice").addClass("rup-language_change_option").text($.rup.i18nParse($.rup.i18n.base,"rup_language.changeLanguage")),
				listadoIdiomas = $("<div>").addClass("rup-language_language_list"), cerrarIdioma = $("<a>").addClass("rup-language_close_languages").attr("id", "rup_language_close").attr("href", "#").attr("title", $.rup.i18nParse($.rup.i18n.base,"rup_global.close")), 
				span = $("<span>").addClass("rup-language_hidden").text($.rup.i18nParse($.rup.i18n.base,"rup_global.close")), ulPrincipal = $("<ul>");
			...
			$.each(this.options.languages, function (key, value) { 
				...
				var liIdioma = $("<li>").attr("id", "rup_language_lng_" + value), txt = $.rup.i18nParse($.rup.i18n.base,"rup_language."+value); 
